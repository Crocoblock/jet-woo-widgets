...
class Jet_Woo_Widgets_Products_Shortcode extends Jet_Woo_Widgets_Shortcode_Base {
	...
	public function get_atts() {
		...
		return apply_filters( 'jet-woo-widgets/shortcodes/jet-woo-products/atts', array(
			'presets'               => array(
				'type'    => 'select',
				'label'   => esc_html__( 'Product Presets', 'jet-woo-widgets' ),
				'default' => 'preset-1',
				'options' => array(
			...
			'show_badges'           => array(
				'type'         => 'switcher',
				'label'        => esc_html__( 'Show Badges', 'jet-woo-widgets' ),
				'label_on'     => esc_html__( 'Yes', 'jet-woo-widgets' ),
				'label_off'    => esc_html__( 'No', 'jet-woo-widgets' ),
				'return_value' => 'yes',
				'default'      => 'yes',
			...
			'sale_badge_text'       => array(
				'type'      => 'text',
				'label'     => esc_html__( 'Set sale badge text', 'jet-woo-widgets' ),
				'default'   => esc_html__( 'Sale!', 'jet-woo-widgets' ),
				'condition' => array(
			...
			'show_excerpt'          => array(
				'type'         => 'switcher',
				'label'        => esc_html__( 'Show Product Excerpt', 'jet-woo-widgets' ),
				'label_on'     => esc_html__( 'Yes', 'jet-woo-widgets' ),
				'label_off'    => esc_html__( 'No', 'jet-woo-widgets' ),
				'return_value' => 'yes',
				'default'      => 'yes',
			...
			'excerpt_length'        => array(
				'type'      => 'number',
				'label'     => esc_html__( 'Excerpt Words Count', 'jet-woo-widgets' ),
				'min'       => 1,
				'default'   => 10,
				'condition' => array(
			...
			'show_tag'              => array(
				'type'         => 'switcher',
				'label'        => esc_html__( 'Show Product Tags', 'jet-woo-widgets' ),
				'label_on'     => esc_html__( 'Yes', 'jet-woo-widgets' ),
				'label_off'    => esc_html__( 'No', 'jet-woo-widgets' ),
				'return_value' => 'yes',
				'default'      => 'yes',
