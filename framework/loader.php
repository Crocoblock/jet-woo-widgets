 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Jet_Woo_Widgets_CX_Loader
 ...
 *     new Twentyseventeen_Jet_Woo_Widgets_CX_Loader(
 *         array(
...
if ( ! class_exists( 'Jet_Woo_Widgets_CX_Loader' ) ) {

	/**
	 * Define Jet_Woo_Widgets_CX_Loader class
	 */
	class Jet_Woo_Widgets_CX_Loader {
